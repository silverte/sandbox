...
variable "rds_aurora_da_cluster_pg_family" {
...
variable "rds_aurora_da_cluster_database_name" {
...
variable "rds_aurora_da_master_username" {
...
variable "rds_aurora_da_master_password" {
...
variable "enable_aurora_postresql_da" {
