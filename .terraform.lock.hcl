...
provider "registry.terraform.io/hashicorp/aws" {
  version     = "5.64.0"
  constraints = ">= 3.29.0, >= 4.21.0, >= 4.33.0, >= 4.36.0, >= 4.66.0, >= 5.12.0, >= 5.27.0, >= 5.30.0, >= 5.35.0, >= 5.37.0, >= 5.47.0, >= 5.49.0, >= 5.58.0, >= 5.59.0, >= 5.61.0, >= 5.62.0, >= 5.64.0"
  hashes = [
